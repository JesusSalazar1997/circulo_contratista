...
import NavDocObr from "./contratista/NavDocObr";
...
const FormularioObra = () => {
    ...
    const { mostrarAlerta, alerta, setAlerta, loading, setLoading } = usePerfil();
    ...
    const handlesubmit = async e => {
        ...
        try {
            ...
            setAlerta({ msg: 'La obra se creo correctamente', error: false });
            setTimeout(() => {
                setAlerta({})
            }, 4000);
    ...
    return (
        <>
            ...
            <section>
                <h2 className="text-2xl font-base text-center my-7">Información Obra</h2>
                <NavDocObr />
